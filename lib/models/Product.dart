...
// END RELATIONSHIPS
  ...
  Product.withFields(this.name, this.description, this.price, this.isActive,
      this.categoryId, this.isDeleted) {
    setDefaultValues();
  }
  Product.withId(this.id, this.name, this.description, this.price,
      this.isActive, this.categoryId, this.isDeleted) {
    setDefaultValues();
  }
  ...
  Future<int> save() async {
    if (id == null || id == 0)
      id = await _mnProduct.insert(Product.withFields(
          name, description, price, isActive, categoryId, isDeleted));
    else
      _mnProduct.update(Product.withId(
          id, name, description, price, isActive, categoryId, isDeleted));
    return id;
  }
...
// END COLLECTIONS
  ...
  Category.fromObjectExclude(dynamic o) {
    this.id = o["id"];
    this.name = o["name"];
    this.isActive = o["isActive"] != null ? o["isActive"] == 1 : null;
    this.isDeleted = o["isDeleted"] != null ? o["isDeleted"] == 1 : null;
  ...
  Future<int> save() async {
    if (id == null || id == 0)
      ...
      _mnCategory.update(Category.withId(id, name, isActive, isDeleted));
    return id;
  }
